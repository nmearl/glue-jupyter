...
from glue_jupyter.renderers.common.state_widgets import HistogramLayerStateWidget
from glue_jupyter.renderers.common.state_widgets.viewer_histogram import HistogramViewerStateWidget
